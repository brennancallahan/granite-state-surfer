...
Break.create([{ name: "Rye on the Rocks", beach: "N/A", address: "190 Ocean Boulevard, Rye, NH 03870", break_group_id: 2, beginner_friendly: false, onsite_parking: true, break_type: "Reef Break"}])
