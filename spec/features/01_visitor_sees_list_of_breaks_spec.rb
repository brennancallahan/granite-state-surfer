...
#     surf_spot = Break.create([{ name: 'Surf Spot', beach: 'Surf Beach', address: '123 beach street, Surf City, NH 03862', break_group_id: 1, beginner_friendly: true, onsite_parking: false, break_type: 'Beach Break' }])
...
#     visit root_path
#
#     expect(page).to have_link("Surf Spot")
#     expect(page).to have_link("Wave Spot")
#
#   end
# end
